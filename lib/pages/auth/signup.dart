...
class _SignupState extends State<Signup> {
  ...
  bool n = false, em = false, p = false, cp = false, deg = false;
    ...
    return Container(
      decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage('assets/register.png'), fit: BoxFit.fitWidth)),
      child: Scaffold(
                      ...
                      TextButton(
                        onPressed: () => {
                          Navigator.pushReplacement(
                              context, ForwardPageRoute(child: const Login()))
                        },
                        child: const Text(
                          'Already a User?',
                          style: TextStyle(
